const nl = {
  ...
  "Password": {
    ...
    "Back": "/security",
    "PasswordDisclaimer": "Kies een wachtwoord van tenminste 8 karakters met minimaal een hoofdletter en een cijfer. Een langer wachtwoord van minimaal 15 karakters mag ook, met een maximum van 72 karakters.",
    "PasswordTooLong": "Je wachtwoord is te lang. Gebruik maximaal 72 karakters.",
  ...
  "account": {
    ...
    "info2": "Let op, je verliest de unieke eduID's die aan je e-mailadres zijn gekoppeld. Wanneer je je opnieuw registreert voor eduID met hetzelfde e-mailadres, krijg je nieuwe eduID's. Sommige applicaties gebruiken deze eduID's om je te herkennen, dus voor die applicaties word je dan gezien als een nieuwe gebruiker. ",
  ...
  "dataActivity": {
    ...
    "info": "Elke applicatie waarvoor je eduID gebruikt ontvangt persoonsgegevens vanuit jouw eduID account. Denk hierbij aan je naam, e-mailadres of aan een uniek eduID waarmee de applicatie jou kan herkennen.",
    "explanation": "Applicaties waarop je bent ingelogd met eduID.",
    "noServices": "Je bent nog niet ingelogd geweest op een applicatie met eduID.",
    "name": "Naam",
    "add": "Nieuwe instelling koppelen",
  ...
  "verify": {
    "modal": {
      ...
      "bank": {
        ...
        "disclaimer": "Met iDIN ontvangen we je naam en geboortedatum van je bank. Op deze manier weten we zeker dat jij het bent. Je doet geen betaling.<strong>Je maakt geen geld over</strong>. <a href='https://www.idin.nl/' target='_blank' rel='noreferrer'>Meer over iDIN.</a>",
  ...
  "serviceDesk": {
    "errorOccured": "Fout opgetreden",
    "errorOccuredInfo": "De servicedesk is momenteel niet bereikbaar. Neem voor ondersteuning contact op met <a href='mailto: help@eduid.nl'>help@eduid.nl</a>."
  }
};
