...
I18n.translations.nl = {
    ...
    profile: {
        ...
        preferredInstitutionInfo: "Wil je de volgende informatie, gebruiken als standaardinformatie om met applicaties te delen?",
        preferred: "{{name}} is nu de bron van je persoonsinformatie",
        expired: "Verlopen",
        newInstitutionTitle: "is succesvol benaderd",
        newInstitutionInfo: "De volgende informatie is toegevoegd aan jouw eduID account.",
        ok: "Ga door",
        yes: "Ja, graag",
        no: "Nee, bedankt",
        eppn: "EPPN",
