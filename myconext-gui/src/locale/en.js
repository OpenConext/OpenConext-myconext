...
I18n.translations.en = {
    ...
    credential: {
        title: "Edit token",
        info: "You added this token on {{date}} at {{hours}}:{{minutes}}",
        name: "Token name",
        cancel: "Cancel",
        update: "Update",
    ...
    webauthn: {
        ...
        updateTitle: "Add token",
        publicKeys: "Your public tokens",
        noPublicKeys: "You have not added any tokens. ",
        nameRequired: "Before you can add a new token you must give it a name.",
        revoke: "Revoke",
        ...
        testFlash: "You successfully tested your security token to authenticate"
    },
    rememberMe: {
