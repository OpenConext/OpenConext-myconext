...
<div class="password">
    <h2>{usePassword ? I18n.t("ChangePassword.Title.ChangePassword") : I18n.t("PasswordResetLink.Title.AddPassword")}</h2>
    ...
    <div class="options">
        ...
        <Button label={I18n.t("ConfirmDelete.Button.Confirm")}
                onClick={proceed}/>
    </div>
</div>
