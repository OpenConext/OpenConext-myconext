const en = {
  ...
  "SubContent": {
    ...
    "Warning": "The service you're logging into has explicitly requested you log in using the eduID app. If you log in with a different method, this application might not work correctly or not allow you access.",
  ...
  "login": {
    ...
    "loginOptionsToolTip": "We offer 3 ways to sign-in:</br><ol><li>You can receive a magic link sent to your email address.</li><li>You can use a password. You must first set this up in My eduID.</li><li>You can use a security key. You must first set this up in My eduID.</li></ol>",
    "email": "Your email address",
    "emailPlaceholder": "e.g. user@gmail.com",
    "passwordPlaceholder": "Password",
    "familyName": "Last name",
  ...
  "verify": {
    "modal": {
      ...
      "bank": {
        ...
        "disclaimer": "With iDIN we control through your bank your personal information, to assure who you are. <strong>You will make no payment</strong>. <a href='https://www.idin.nl/' target='_blank' rel='noreferrer'>More about IdIN.</a>",
