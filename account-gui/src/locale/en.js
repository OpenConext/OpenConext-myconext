...
I18n.translations.en = {
    login: {
        ...
        institutionDomainNameWarning: "You entered an institutional email address. Please note that when your enrollment ends, that email address will also be terminated.",
        institutionDomainNameWarning2: "We advice you to use a personal email address for your eduID account.",
