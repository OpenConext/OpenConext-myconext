...
I18n.translations.nl = {
    ...
    eppnAlreadyLinked: {
        ...
        info: "Je eduID kon niet worden gekoppeld, omdat het vertrouwde account waarmee je bent ingelogd, al aan een ander eduID-account met identifier {{eppn}} is gekoppeld.",
        proceed: "Je kan het nogmaals met een andere instelling proberen of doorgaan naar {{name}}",
        proceedLink: "Doorgaan",
        retryLink: "Opnieuw proberen"
    },
