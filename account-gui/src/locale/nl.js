...
I18n.translations.nl = {
  login: {
    ...
    institutionDomainNameWarning: "Je hebt een instellings e-mailadres ingevoerd. Houd er rekening mee dat wanneer je inschrijving eindigt, dat e-mailadres ook wordt beëindigd.",
    institutionDomainNameWarning2: "We raden je aan om een persoonlijk e-mailadres te gebruiken voor je eduID-account.",
